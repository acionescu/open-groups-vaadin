...
//    protected void displayList(UserAction ua, OpenGroupsApplication app, ComponentContainer targetContainer,GenericNameValueList list,boolean showEntityType) {
...
//	    getActionsManager().executeAction(ActionsManager.OPEN_SELECTED_ENTITY, currentEntity, app,entityContainer,false);
//	   
//	}
//    }
    
    protected void displayList(UserAction ua, OpenGroupsApplication app, ComponentContainer targetContainer,EntityList list) {
	ComponentContainer displayArea = targetContainer;
//	Table displayArea = targetContainer;
	displayArea.removeAllComponents();
//	displayArea.removeAllItems();
